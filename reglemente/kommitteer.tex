...
Denna mandatperiod är om inget annat specifieras tills verksamhetsårets slut, men sektionsstyrelsen kan även välja in sekundanter en kortare period.
Sekundanterna räknas inte som ledamöter i DNS, och har inte samma rättigheter som ledamöter.
Några exempel på uppdrag för sekundanter:
\begin{itemize}
  \item Driva ärenden som pågår en längre period
  \item Gå på kursnämdsmöten och föra protokoll
  \item Arbeta med projekt, till exempel hålla i data101
\end{itemize}
\subsubsection{Ansvar}
\begin{itemize}
...
%Hur bestämms kommitteens alpha?
\subsubsection{Mandatperiod}
...
\subsection{MECS}
\subsubsection{Uppdrag}
MECS har i uppdrag att sköta mastermottagningen.
\subsubsection{Ledamöter}
MECS består av ordförande och 5--6 övriga ledamöter.
\subsubsection{Mandatperiod}
Mandatperioden är 1:a januari -- 31:a december.
