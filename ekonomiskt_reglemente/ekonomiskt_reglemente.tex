...
Kommittéer används som ett samlingsnamn för kommittéer och sektionsstyrelsen.

\subsection{Filosofi}
Detta reglemente har skapats för att skapa tydlighet över vad sektionens pengar får och inte får användas till. 
Det är därmed tänkt att vara ett hjälpmedel för sektionsstyrelsen, revisorerna och sektionens kommittéer i deras arbete.
...
Varje kommittés budgetförslag ska godkännas av sektionsstyrelsen, som rapporterar vidare relevant information till sektionsmötet.
...
Varje intresseförenings budgetförslag ska godkännas av sektionsstyrelsen, som rapporterar vidare relevant information till sektionsmötet

\subsection{Kapital}
\subsubsection{Startkapital}
Intresseförening skall vid mandatperiodens början inte ha några tillgångar.
\subsubsection{Slutkapital}
Samtliga intresseföreningars tillgångar och skulder tillfaller sektionsstyrelsen vid mandatperiodens slut.
\subsubsection{Stödkapital}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Äskning}
\subsection{Till sektionsstyrelsen}
...
Styret kan bevilja extra medel om beloppet faller inom ramarna för de olika fonderna som sektionsstyrelsen förvaltar. Om äskningen inte fallar inom dessa ramar kan den ändå beviljas förutsatt att beloppet understiger \prisbasbelopp{0.25} och inte överstiger sektionens budget.
\subsection{Till sektionsmötet}
Medlem, kommittéer eller intresseföreningar kan också inkomma med önskemål om extra ekonomiska medel till sin verksamhet eller arrangemang genom motion till sektionsmötet. Finansieringen av motionen ska göras med prioritet på medel från de fonder som sektionsstyrelsen förvaltar.
...
sektionsstyrelsen innan inköp. Detta genom att kommittén skickar in plan för aspningen samt
en kostnadskalkyl som sektionsstyrelsen baserar sitt beslut på.
...
kommitté få godkännande av sektionsstyrelsen innan inköp. Detta genom att kommittén
skickar förslag på kläder och en uppskattad kostnad som sektionsstyrelsen baserar
sitt beslut på.
...
När sektionsstyrelsen beslutar huruvida ett förslag godkänns ska följande tas hänsyn till:
\begin{itemize}
...
Alla uttag ur fonder ska redovisas på sektionsmöte i sektionsstyrelsens verksamhetsrapport.
...
\begin{itemize}
\item En av sektionsstyrelsen budgeterad summa som godkänts av sektionsmötet.
...
\subsubsection{Uttag}
\begin{itemize}
\item Sektionsstyrelsen disponerar sjuttiofem (75) \% av årets tillförda kapital, enligt \secref{sec:lokalfond_avsattning}, för basdrift av sektionslokalerna.
...
\subsubsection{Avsättning}
\begin{itemize}
\item En av sektionsstyrelsens budgeterad summa som godkänts av sektionsmötet.
